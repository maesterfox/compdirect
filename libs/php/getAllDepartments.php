...
// Filtering logic
$deptId = isset($_GET['departmentId']) ? $_GET['departmentId'] : null;
$locId = isset($_GET['locationId']) ? $_GET['locationId'] : null;
...
if ($deptId) {
	$query .= " WHERE department.id = " . $deptId;
} elseif ($locId) {
	$query .= " WHERE location.id = " . $locId;
}
